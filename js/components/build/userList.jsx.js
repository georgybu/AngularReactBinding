    ...
    window.Components.userList = React.createClass({
        ...
        render: function() {
            ...
            var userList = _.map(this.props.list, function(user, i) {
                ...
                return (
                    React.createElement("li", {className: classes, onClick: clickHandler}, 
                        React.createElement("span", null,  (i+1) + ". "+ user.name), 
            ...
            return (React.createElement("ul", {className: "user-list"}, userList));
        }
    });
}(window.React));
